...
import com.enoca.commerce.security.jwt.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/carts/**").hasRole(Role.ADMIN.name())
                .antMatchers("/api/products/**").hasRole(Role.ADMIN.name())
                .antMatchers("/api/products/getproduct/{productId}").permitAll()
